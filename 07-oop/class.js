...
class ProductPage {
  ...
  themSanPham(ten, gia) {
  console.log(`Gõ tên sản phẩm ${ten} vào ${this.txtTenSP}`);
  console.log(`Gõ giá sản phẩm vào ${gia} vào ${this.txtGia}`);
  console.log(`Click thêm vào giỏ hàng ${this.btnGioHang}`);
}
kiemTraThongBao() {
  console.log(`Kiểm tra thông báo ${this.modalThongBao}`);
}
...
productPage.thucHienThemVaKiemTra("laptop", 30000)
